          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10 text-left">
              {data.features.map((feature, idx) => (
                <div key={idx} className="bg-black/20 p-4 rounded-xl border border-white/5 flex items-center gap-4">
                  {idx === 0 ? <Briefcase className="w-6 h-6 text-primary shrink-0" /> : <FileText className="w-6 h-6 text-primary shrink-0" />}
